<template>
  <div class="auth-container">
    <div class="auth-slider-wrapper">
      <div class="auth-slider" :class="{ 'slide-right': showRegister }">
        <!-- Login Form -->
        <div class="auth-form login-form">
          ...
          <div class="auth-footer">
            <p>
              ...
              <a href="#" @click.prevent="showRegister = true" class="auth-link">Sign Up</a>
            </p>
          </div>
        </div>
        ...
        <div class="auth-form register-form">
          ...
          <div class="auth-footer">
            <p>
              ...
              <a href="#" @click.prevent="showRegister = false" class="auth-link">Sign In</a>
            </p>
          </div>
        </div>
      </div>
